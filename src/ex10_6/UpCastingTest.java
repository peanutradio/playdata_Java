package ex10_6; // 상속과 업캐스팅: '부모 타입 배열'에 자식 객체 담기.
...
class Square extends Shape {
	...
	void printInfo() {
		System.out.println("Square:name="+name+",width="+width+",height="+height);
	}
...
class Circle extends Shape {
	int radius;
	void printInfo() {
		System.out.println("Circle:name="+name+",radius="+radius);
}
}
public class UpCastingTest {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<sa.length; i++) {
			...
			System.out.println("sa["+i+"].printInfo() call!!");
			sa[i].printInfo();
